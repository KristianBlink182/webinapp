...
$condoSlug = rawurlencode($condoNombre);
        ...
        <div class="livo-bottom-grid">
            <a href="{{ $urlPagos }}" class="livo-service-card">
            ...
            <a href="{{ $urlComunicados }}" class="livo-service-card">
            ...
            <a href="/vecino/edificio/{{ $condoNombre }}/mascotas" class="livo-service-card">
            ...
            <a href="/vecino/edificio/{{ $condoNombre }}/reclamos" class="livo-service-card">
