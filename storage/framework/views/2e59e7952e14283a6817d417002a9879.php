...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-panels::components.layout.base','data' => ['livewire' => $livewire ?? null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['livewire' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($livewire ?? null)]); ?>
    <style>
        ...
        <div class="livo-left-banner">
            ...
            <div style="position: relative; z-index: 10; max-width: 480px; margin: auto 0;">
                <span class="livo-badge">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains(request()->url(), 'admin')): ?>
                        PANEL DE ADMINISTRACIÓN
                    <?php elseif(str_contains(request()->url(), 'master')): ?>
                        PANEL DE SUPERADMIN
                    <?php elseif(str_contains(request()->url(), 'porteria')): ?>
                        PANEL DE PORTERÍA
                    <?php else: ?>
                        APP DE RESIDENTES
            ...
            <div style="position: relative; z-index: 10; font-size: 0.8rem; color: #64748b;">
                LIVO &copy; <?php echo e(date('Y')); ?> &bull; Administración Inteligente para Edificios
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\sistema-condominio\resources\views/vendor/filament-panels/components/layout/simple.blade.php ENDPATH**/ ?>