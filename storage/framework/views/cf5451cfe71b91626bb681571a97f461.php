...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-6" wire:poll.3s x-data="{ openSalvoModal: false }">
            ...
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div>
                    <h1 class="porteria-title-text" style="font-size: 1.6rem; font-weight: 800; margin: 0; display: flex; align-items: center; gap: 0.5rem;">
                        <span>Bienvenido, <?php echo e($nombrePortero); ?> 👋</span>
                    </h1>
                    <p class="porteria-muted-text" style="font-size: 0.85rem; margin-top: 0.25rem; font-weight: 600;">
                        Terminal de Seguridad y Control de Accesos de <span style="color: #0284c7; font-weight: 800;"><?php echo e($tenant?->nombre ?? 'Condominio'); ?></span>.
                    </p>
                </div>
            </div>
        ...
        <div class="porteria-card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($alertasSOS) && (($alertasSOS->where('estado', 'Pendiente')->count() ?? 0) > 0 || (isset($auxiliosSismo) && $auxiliosSismo->count() > 0))): ?>
                <div style="margin-bottom: 1.5rem; padding: 1.25rem; background: linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%); border: 2px solid #ef4444; border-radius: 1rem; box-shadow: 0 0 25px rgba(239, 68, 68, 0.3);">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($alertasSOS)): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $alertasSOS->where('estado', 'Pendiente'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.75rem 1rem; background: #ffffff; border: 1px solid #fca5a5; border-radius: 0.75rem; margin-bottom: 0.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                                <div>
                                    <span style="font-weight: 900; color: #991b1b; font-size: 0.95rem;">🚨 S.O.S. - Dpto. <?php echo e($sos->departamento?->numero ?? 'N/A'); ?></span>
                                    <span style="font-size: 0.85rem; color: #7f1d1d; font-weight: 800; margin-left: 0.5rem;">(<?php echo e($sos->user?->name ?? 'Residente'); ?>)</span>
                                </div>
                                <button wire:click="atenderSOS(<?php echo e($sos->id); ?>)" type="button" style="padding: 0.45rem 1rem; background: #10b981; color: #ffffff; font-weight: 800; font-size: 0.75rem; border-radius: 0.5rem; border: none; cursor: pointer; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);">
                                    ✓ Marcar Atendido
                                </button>
                            </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($auxiliosSismo)): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $auxiliosSismo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auxilio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.75rem 1rem; background: #ffffff; border: 1px solid #fca5a5; border-radius: 0.75rem; margin-bottom: 0.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                                <div>
                                    <span style="font-weight: 900; color: #dc2626; font-size: 0.95rem;">🚨 AUXILIO SISMO - Dpto. <?php echo e($auxilio->departamento?->numero ?? 'N/A'); ?></span>
                                    <span style="font-size: 0.85rem; color: #7f1d1d; font-weight: 800; margin-left: 0.5rem;">(<?php echo e($auxilio->user?->name); ?>)</span>
                                </div>
                                <button wire:click="atenderAuxilioSismo(<?php echo e($auxilio->id); ?>)" type="button" style="padding: 0.45rem 1rem; background: #10b981; color: #ffffff; font-weight: 800; font-size: 0.75rem; border-radius: 0.5rem; border: none; cursor: pointer; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);">
                                    ✓ Marcar Atendido
                                </button>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.25rem;">
                <div class="porteria-op-btn" style="justify-content: space-between;">
                    <div>
                        ...
                        <div class="porteria-title-text" style="font-size: 2rem; font-weight: 800; color: #38bdf8;"><?php echo e($visitasConteo); ?></div>
                    </div>
                ...
                <div class="porteria-op-btn" style="justify-content: space-between;">
                    <div>
                        ...
                        <div class="porteria-title-text" style="font-size: 2rem; font-weight: 800; color: #f59e0b;"><?php echo e($paquetesConteo); ?></div>
                    </div>
            ...
            <div class="porteria-grid-6">
                <a href="<?php echo e(\App\Filament\Porteria\Resources\VisitaResource::getUrl('index')); ?>" class="porteria-op-btn">
                ...
                <a href="<?php echo e(\App\Filament\Porteria\Resources\PaqueteResource::getUrl('index')); ?>" class="porteria-op-btn">
                ...
                <div class="porteria-op-btn">
                    ...
                    <div>
                        <div style="font-weight: 800; font-size: 0.95rem;">Alertas S.O.S. (<?php echo e(isset($alertasSOS) ? $alertasSOS->where('estado', 'Pendiente')->count() : 0); ?>)</div>
                ...
                <div class="porteria-op-btn">
                    ...
                    <div>
                        <div style="font-weight: 800; font-size: 0.95rem;">Sismo Auxilio (<?php echo e(isset($auxiliosSismo) ? $auxiliosSismo->count() : 0); ?>)</div>
                ...
                <div class="porteria-op-btn" @click="openSalvoModal = true">
                    ...
                    <div>
                        <div style="font-weight: 800; font-size: 0.95rem;">Sismo A Salvo (<?php echo e($aSalvoConteo); ?>)</div>
                        <div class="porteria-muted-text" style="font-size: 0.75rem;">Clic para ver registro</div>
                    </div>
                </div>

                <a href="<?php echo e(\App\Filament\Porteria\Resources\ReservaResource::getUrl('index')); ?>" class="porteria-op-btn">
            ...
            <div style="margin-top: 2rem; padding-top: 1.25rem; border-top: 1px solid rgba(148, 163, 184, 0.2);">
                ...
                <div style="overflow-x: auto;">
                    <table class="porteria-table">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($historialSOS)): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $historialSOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    <tr>
                                        <td class="porteria-title-text" style="font-weight: 800;">
                                            Dpto. <?php echo e($sos->departamento?->numero ?? 'N/A'); ?>

                                            <div class="porteria-muted-text" style="font-weight: 400; font-size: 0.75rem;"><?php echo e($sos->user?->name ?? 'Residente'); ?></div>
                                        </td>
                                        <td>
                                            <span style="padding: 0.2rem 0.55rem; background: rgba(239, 68, 68, 0.15); color: #dc2626; border-radius: 9999px; font-weight: 700; font-size: 0.7rem;">
                                                🚨 <?php echo e($sos->tipo ?? 'Emergencia'); ?>

                                            </span>
                                        </td>
                                        <td><?php echo e($emision->format('d/m/Y h:i A')); ?></td>
                                        <td><?php echo e($atencion ? $atencion->format('d/m/Y h:i A') : '—'); ?></td>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($atencion): ?>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sos->estado === 'Atendido'): ?>
        ...
        <div x-show="openSalvoModal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.75); backdrop-filter: blur(8px); display: flex; align-items: center; justify-content: center; z-index: 9999; padding: 1rem;" x-cloak>
            <div @click.away="openSalvoModal = false" style="background: #0f172a; border: 1px solid #334155; border-radius: 1.5rem; max-width: 600px; width: 100%; padding: 2rem; color: #ffffff; box-shadow: 0 20px 50px rgba(0,0,0,0.5);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.25rem;">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        ...
                        <div>
                            ...
                            <span style="font-size: 0.75rem; color: #34d399; font-weight: 800; text-transform: uppercase;">Total: <?php echo e($aSalvoConteo); ?> Confirmados</span>
                        </div>
                    </div>
                ...
                <div style="max-height: 350px; overflow-y: auto;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($confirmadosASalvo) && count($confirmadosASalvo) > 0): ?>
                        <table style="width: 100%; text-align: left; border-collapse: collapse; font-size: 0.85rem;">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $confirmadosASalvo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salvo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                                        <td style="padding: 0.75rem 0.6rem; font-weight: 800; color: #38bdf8;">Dpto. <?php echo e($salvo->departamento?->numero ?? 'N/A'); ?></td>
                                        <td style="padding: 0.75rem 0.6rem; font-weight: 700; color: #ffffff;"><?php echo e($salvo->user?->name ?? 'Residente'); ?></td>
                                        <td style="padding: 0.75rem 0.6rem; color: #cbd5e1;"><?php echo e(\Carbon\Carbon::parse($salvo->updated_at)->timezone('America/Lima')->format('d/m/Y - h:i A')); ?></td>
...
<?php endif; ?><?php /**PATH C:\laragon\www\sistema-condominio\resources\views/filament/porteria/widgets/porteria-command-center.blade.php ENDPATH**/ ?>