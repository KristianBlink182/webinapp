...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLoggedIn && !$isLoginRoute): ?>
    ...
    <div class="livo-mobile-navbar">
        <a href="<?php echo e($urlEscritorio); ?>" class="livo-nav-item <?php echo e(str_contains($currentUrl, 'escritorio') ? 'active' : ''); ?>">
            <span style="font-size: 1.25rem;">🏠</span>
            <span>Escritorio</span>
        </a>

        <a href="<?php echo e($urlFinanzas); ?>" class="livo-nav-item <?php echo e(str_contains($currentUrl, 'finanzas') ? 'active' : ''); ?>">
            <span style="font-size: 1.25rem;">💰</span>
            <span>Finanzas</span>
        </a>

        <a href="<?php echo e($urlSeguridad); ?>" class="livo-nav-item <?php echo e(str_contains($currentUrl, 'seguridad') ? 'active' : ''); ?>">
            <span style="font-size: 1.25rem;">🛡️</span>
            <span>Seguridad</span>
        </a>

        <a href="<?php echo e($urlGestion); ?>" class="livo-nav-item <?php echo e(str_contains($currentUrl, 'gestion') ? 'active' : ''); ?>">
            <span style="font-size: 1.25rem;">⚙️</span>
            <span>Gestión</span>
        </a>

        <a href="<?php echo e($urlComunidad); ?>" class="livo-nav-item <?php echo e(str_contains($currentUrl, 'comunidad') ? 'active' : ''); ?>">
            <span style="font-size: 1.25rem;">👥</span>
            <span>Comunidad</span>
        </a>
    </div>
