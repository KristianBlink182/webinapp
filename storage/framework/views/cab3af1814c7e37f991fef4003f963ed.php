...
$condoSlug = rawurlencode($condoNombre);
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalPaquetes > 0): ?>
            <div class="livo-paquete-bar">
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        <div style="font-weight: 800; font-size: 1.05rem; color: #ffffff;">📦 ¡TIENES <?php echo e($totalPaquetes); ?> ENCOMIENDA(S) EN PORTERÍA!</div>
        ...
        <div class="livo-welcome-card">
            <div>
                <h1 class="livo-welcome-title" style="font-size: 1.4rem; font-weight: 800; margin: 0; display: flex; align-items: center; gap: 0.5rem;">
                    <span>👋 ¡Bienvenido, <?php echo e($authUser->name); ?>!</span>
                </h1>
                <p class="livo-welcome-subtitle" style="font-size: 0.95rem; margin-top: 0.25rem; font-weight: 600;">
                    <span style="color: #0284c7; font-weight: 800;">Departamento <?php echo e($numeroDpto); ?></span> — <?php echo e($condoNombre); ?>
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alertaActiva): ?>
        ...
        <div class="livo-top-grid">
            <div class="livo-card-purple">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        ...
                        <div style="font-size: 1.8rem; font-weight: 900; margin-top: 0.2rem;">
                            S/ <?php echo e(number_format($deudaTotal ?? 0, 2)); ?>
                ...
                <div style="padding-top: 0.75rem; border-top: 1px solid rgba(255, 255, 255, 0.15); font-size: 0.75rem; font-weight: 600;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($deudaTotal ?? 0) > 0): ?> ⚠️ Tienes recibos pendientes <?php else: ?> ✅ ¡Estás al día! <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <div class="livo-card-teal">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        ...
                        <div style="font-size: 1.1rem; font-weight: 800; margin-top: 0.2rem;">
                            <?php echo e($ultimoAviso?->titulo ?? 'Sin comunicados'); ?>

                        </div>
                        <div style="font-size: 0.75rem; opacity: 0.8; margin-top: 0.2rem;">
                            <?php echo e(Str::limit($ultimoAviso?->contenido ?? 'No hay novedades', 45)); ?>
                ...
                <div style="padding-top: 0.75rem; border-top: 1px solid rgba(255, 255, 255, 0.15);">
                    <a href="/vecino/edificio/<?php echo e($condoNombre); ?>/comunicados" style="color: #ffffff; font-size: 0.75rem; font-weight: 700; text-decoration: none;">
        ...
        <div class="livo-services-title">SERVICIOS DEL CONDOMINIO</div>
        <div class="livo-bottom-grid">
            <a href="<?php echo e($urlPagos); ?>" class="livo-service-card">
                <div class="livo-service-icon" style="background: rgba(124, 58, 237, 0.2); color: #a855f7;">
                    <svg style="width: 24px; height: 24px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                </div>
                <div>Mis Pagos</div>
                <div>Recibos y vouchers</div>
            </a>

            <a href="<?php echo e($urlComunicados); ?>" class="livo-service-card">
                <div class="livo-service-icon" style="background: rgba(13, 148, 136, 0.2); color: #14b8a6;">
            ...
            <a href="/vecino/edificio/<?php echo e($condoNombre); ?>/mascotas" class="livo-service-card">
                <div class="livo-service-icon" style="background: rgba(236, 72, 153, 0.2); color: #ec4899;">
                    <svg style="width: 24px; height: 24px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
                </div>
                <div>Mascotas</div>
                <div>Registro</div>
            </a>

            <a href="/vecino/edificio/<?php echo e($condoNombre); ?>/reclamos" class="livo-service-card">
                <div class="livo-service-icon" style="background: rgba(16, 185, 129, 0.2); color: #10b981;">
        ...
        <div class="livo-mobile-navbar">
            <a href="<?php echo e($urlEscritorio); ?>" class="livo-nav-item active">
                <span style="font-size: 1.25rem;">🏠</span>
                <span>Escritorio</span>
            </a>
            <a href="<?php echo e($urlPagos); ?>" class="livo-nav-item">
                <span style="font-size: 1.25rem;">💰</span>
                <span>Finanzas</span>
            </a>
            <a href="<?php echo e($urlInvitados); ?>" class="livo-nav-item">
                <span style="font-size: 1.25rem;">🛡️</span>
                <span>Seguridad</span>
            </a>
            <a href="<?php echo e($urlReservas); ?>" class="livo-nav-item">
                <span style="font-size: 1.25rem;">⚙️</span>
                <span>Gestión</span>
            </a>
            <a href="<?php echo e($urlComunicados); ?>" class="livo-nav-item">
                <span style="font-size: 1.25rem;">👥</span>
                <span>Comunidad</span>
            </a>
        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\sistema-condominio\resources\views/filament/vecino/pages/dashboard.blade.php ENDPATH**/ ?>